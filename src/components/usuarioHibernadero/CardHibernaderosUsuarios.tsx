...
export const CardHibernaderosUsuarios = (hibernadero: HibernaderoInterface) => {
  return (
    <>
      <Card>
        ...
        <CardBody className="text-gray-600 w-full">
          ...
          <div>
            <p className="w-full text-center font-sans font-semibold uppercase text-warning">Propietario: {hibernadero.encargado}</p>
          </div>
