import Grafica1 from '../../assets/GRAFICA.png'

export const Characteristics = () => {
  return (
    <div id="caracteristicas" className="p-8 xl:p-20">
      <div className="mb-8">
        <h1 className="text-[40px] font-black">
        CaracterÃ­sticas
        </h1>
        <p className="text-xl text-gray-500">
        Transforma datos complejos en imágenes vívidas para simplificar el análisis, supervisar el rendimiento y mostrar los datos de una manera fácil de usar.
        </p>
      </div>
      {/* Works */}
